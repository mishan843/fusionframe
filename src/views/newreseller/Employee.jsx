...
import { addResellerEMP, UpdateResellerEMP } from 'services/ResellerService';
...
export default function Employee({ setLoading, open, setOpen, mode, getEmployeeData, employee, setEmployee, resellerID }) {
            ...
            try {
                ...
                if (mode === 'add') {
                    data = {
                        ...
                        resellerId: userId ? userId : resellerID
                    }
                    await addResellerEMP(data);
                } else if (mode === 'edit') {
                    data = {
                        updates: {
                            ...values,
